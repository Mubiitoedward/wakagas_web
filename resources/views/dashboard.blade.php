          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3>{{\App\Models\MultiplierRecord::count()}}</h3> 
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                <div class="inner">
                  <h3>{{\App\Models\Service_provider_records::count()}}</h3> 
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Varrieties of seed vs Demand</h3>
           ...
           <!-- DONUT CHART -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Stock Of Seed Vs varriety</h3>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Etesoti vs Serenut Demand</h3>
